...
//   - Pokémon : testé "nom + extension" (comme Magic) à la demande de
//     l'utilisateur le 09/08/2026 — confirmé NON fonctionnel en conditions
//     réelles (plusieurs formats essayés, rien reconnu), conforme à la doc
//     Cardmarket qui exige en plus le texte des attaques/capacités
//     ("Umbreon EX Moon Mirage Onyx", pas juste "Umbreon") — donnée qu'on n'a
//     pas dans UnifiedCard. Retiré : pas de format qu'on puisse générer avec
//     nos données qui fonctionne pour ce jeu.
